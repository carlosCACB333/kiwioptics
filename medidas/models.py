...
class Prescription(models.Model):
    ...
    # intermediate_spherical_right = models.DecimalField("Esf. derecho Lejos", max_digits=4, decimal_places=2, blank=True, null=True,choices=spherical_choices)
    # intermediate_cylinder_right = models.DecimalField("Cil. derecho Lejos", max_digits=4, decimal_places=2, blank=True, null=True, choices=cylinder_choices)
    # intermediate_axis_right = models.PositiveSmallIntegerField("Eje derecho Lejos", validators=[MaxValueValidator(180,'El eje solo permite valores entre 0° y 180°')], blank=True, null=True, choices=axis_choices)
    # intermediate_av_right = models.CharField("Av. derecho lejos",max_length=50, blank=True, null=True)
    # intermediate_spherical_left = models.DecimalField("Esf. izquierdo Lejos", max_digits=4, decimal_places=2, blank=True, null=True,choices=spherical_choices)
    # intermediate_cylinder_left = models.DecimalField("Cil. izquierdo Lejos", max_digits=4, decimal_places=2, blank=True, null=True, choices=cylinder_choices)
    # intermediate_axis_left = models.PositiveSmallIntegerField("Eje izquierdo Lejos",validators=[MaxValueValidator(180,'El eje solo permite valores entre 0° y 180°')], blank=True, null=True, choices=axis_choices)
    # intermediate_av_left = models.CharField("Av. izquierdo lejos",max_length=50, blank=True, null=True)
